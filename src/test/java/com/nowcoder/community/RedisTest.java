...
public class RedisTest {
    ...
    public void testKeys(){
        ...
        redisTemplate.expire("test:students",3, TimeUnit.SECONDS);
    }
    ...
    /**
     * 测试编程式事务
     * 关系型数据库是ACID的，Redis不是的
     * ，Redis把命令存到队列中，在事务提交之后才会传给服务器，服务器再统一批量查询
     * ，所以在事务未提交时，查询到的结果为空。
     */
    @Test
    public void testTransaction(){
        Object result = redisTemplate.execute(new SessionCallback() {
            ...
            public Object execute(RedisOperations redisOperations) throws DataAccessException {
                ...
                System.out.println(redisOperations.opsForSet().members(redisKey));// 在redis的事务中查询，查询到的值为空
